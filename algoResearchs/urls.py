...
urlpatterns = [
    ...
    path('iacuc/submission/<int:submission_id>/home/', admin_views.iacuc_submission_home, name='iacuc_submission_home'),
    path('iacuc/<int:submission_id>/search-users/', admin_views.search_submission_users, name='search_submission_users'),
    path('iacuc/<int:submission_id>/add-users/', admin_views.add_submission_users, name='add_submission_users'),
    path('iacuc/<int:submission_id>/get-users/', admin_views.get_submission_users, name='get_submission_users'),
    ...
    path('iacuc/<int:org_id>/', admin_views.iacuc_dashboard, name='iacuc_dashboard'),
    ...
    path('org/<int:org_id>/iacuc/manage/', admin_views.manage_iacuc_committee, name='manage_iacuc_committee'),
    path('iacuc/member/<int:member_id>/remove/', admin_views.remove_iacuc_member, name='remove_iacuc_member'),
    ...
    path('iacuc/<int:submission_id>/section-notes/<str:section_id>/', admin_views.iacuc_section_notes, name='iacuc_section_notes'),
    path('iacuc/<int:submission_id>/overview/save/', admin_views.iacuc_save_overview, name='iacuc_save_overview'),
    path('iacuc/<int:submission_id>/update/<str:field_name>/', admin_views.iacuc_update_field, name='iacuc_update_field'),
    path("iacuc/<int:submission_id>/add-personnel/", admin_views.add_personnel_entry, name="add_personnel_entry"),
    path('<int:org_id>/projects/<int:project_id>/add-note/', admin_views.add_note, name='add_note'),
    ...
    path('<int:org_id>/projects/<int:project_id>/history/', admin_views.project_history, name='project_history'),
    ...
    path("admin/forms/<int:org_id>/<int:form_id>/download_phs_plan/",admin_views.download_phs_research_plan_pdf,name="download_phs_research_plan_pdf",),
    ...
    path('funds/<str:fund_id>/add-reference/', admin_views.add_reference_for_fund, name='add_reference_for_fund'),
    ...
    path('admin/irb-committee/<int:org_id>/', admin_views.manage_irb_committee, name='manage_irb_committee'),
    path('admin/irb-member/remove/<int:member_id>/', admin_views.remove_irb_member, name='remove_irb_member'),
    path('irb/<int:submission_id>/status-transition/', admin_views.irb_status_transition, name='irb_status_transition'),
    path('irb/<int:submission_id>/save-funding/', admin_views.save_irb_funding_entries, name='save_irb_funding_entries'),
    path('irb/<int:submission_id>/fillout/<str:section>/', admin_views.irb_fill_out_section, name='irb_fill_out_section'),
    path('irb/<int:submission_id>/next-section/<str:current_section>/', admin_views.irb_fill_out_next_section, name='irb_fill_out_next_section'),
    ...
    path('edit-external-collab/<int:collab_id>/', admin_views.edit_external_collab, name='edit_external_collab'),
    path('delete-external-collab/<int:collab_id>/', admin_views.delete_external_collab, name='delete_external_collab'),
    path('edit-off-campus/<int:entry_id>/', admin_views.edit_off_campus, name='edit_off_campus'),
    path('delete-off-campus/<int:entry_id>/', admin_views.delete_off_campus, name='delete_off_campus'),
    path('delete-strain/', data_collection_views.delete_strain, name='delete_strain'),
     path('funding/edit/<int:pk>/', admin_views.edit_funding_source, name='edit_funding_source'),
    path('funding/delete/<int:pk>/', admin_views.delete_funding_source, name='delete_funding_source'),
    ...
    path('<int:org_id>/personnel/<str:unique_id>/', admin_views.specific_personnel, name='specific_personnel'),
    # urls.py
    ...
    path('organization/<int:org_id>/reports/add-employee/', admin_views.add_employee_entry, name='add_employee_entry'),
    path('<int:org_id>/fund-personnel/', admin_views.fund_personnel, name='fund_personnel'),
    path('<int:org_id>/report/', admin_views.fund_report, name='fund_report'),
    path('organization/<int:org_id>/glossary/', admin_views.org_glossary, name='org_glossary'),
    path('<int:org_id>/glossary/', admin_views.glossary_view, name='glossary_view'),
    path('<int:org_id>/glossary/add/', admin_views.add_glossary_item, name='add_glossary_item'),
