...
urlpatterns = [
    ...
    path(
        ...
        form_views.download_all_forms_combined_pdf,
    ...
    path('fund-finder/', user_views.fund_finder, name='fund_finder'),
    path('system-to-system/', user_views.system_to_system, name='system_to_system'),
    path('sponsored-programs/', user_views.sponsored_programs, name='sponsored_programs'),
    path('fund-manager/', user_views.fund_manager, name='fund_manager'),
    path('effort_report/', user_views.effort_report, name='effort_report'),
    path('human-safety/', user_views.human_safety, name='human_safety'),
    path('animal-safety/', user_views.animal_safety, name='animal_safety'),
    path('bio-safety/', user_views.bio_safety, name='bio_safety'),
    path('conflict-of-int', user_views.conflict_of_int, name='conflict_of_int'),
    ...
    path('in-vivo/', user_views.in_vivo, name='in_vivo'),
    path('vivarium-front/', user_views.vivarium_front, name='vivarium_front'),
    path('scheduler/', user_views.scheduler, name='scheduler'),
    path('insight/', user_views.insight, name='insight'),
