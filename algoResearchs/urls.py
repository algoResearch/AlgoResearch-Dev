...
urlpatterns = [
    ...
    path('organization/<int:org_id>/experiments/<int:experiment_id>/get-available-rfids/', active_experiment_views.get_available_rfids, name='get_available_rfids'),
    ...
    path('<int:org_id>/next-step/', create_experiment_views.next_step, name='next_step_url'),
    path('<int:org_id>/final-step/<int:experiment_id>/', create_experiment_views.final_step, name='final_step_url'),
