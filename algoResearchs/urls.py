...
urlpatterns = [
    ...
    path('<int:org_id>/experiment-summary/<int:experiment_id>/', active_experiment_views.experiment_summary, name='experiment_summary'),
    ...
    path('organizations/<int:org_id>/experiments/<int:experiment_id>/get-available-rfids/', active_experiment_views.get_available_rfids, name='get_available_rfids'),
    ...
    path('<int:org_id>/pdf-template/<int:template_id>/submit/', user_views.submit_filled_pdf_template, name='submit_filled_pdf_template'),
    ...
    path('<int:org_id>/respond-friend-request/', user_views.respond_friend_request, name='respond_friend_request'),
    ...
    path('<int:org_id>/forms/<int:form_id>/submit/', user_views.submit_filled_form, name='submit_filled_form'),
    path('<int:org_id>/forms/<int:pdf_template_id>/confirmation/', user_views.submission_confirmation, name='submission_confirmation'),
    path('<int:org_id>/adverse-event-form/', user_views.adverse_event_form, name='adverse_event_form'),
    path('<int:org_id>/submit-adverse-event/', user_views.submit_adverse_event, name='submit_adverse_event'),
    ...
    path('<int:org_id>/animal-care-concern-form/', user_views.animal_care_concern_form, name='animal_care_concern_form'),
    path('<int:org_id>/submit-animal-care-concern/', user_views.submit_animal_care_concern, name='submit_animal_care_concern'),
