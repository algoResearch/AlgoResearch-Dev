...
from dashboard.models import User, Organization, Opportunity, FormPackage, PackageForm
from dashboard.forms import *
from myapp.utils.parsing import parse_date  # wherever your parse_date lives
from datetime import datetime
from dashboard.views import user_views
from dashboard.views.users.user_views import send_2fa_code 
import os
...
def it_create_user(request):
    ...
    return render(request, 'it_admin/create_user.html', {'form': form, 'organizations': organizations})
