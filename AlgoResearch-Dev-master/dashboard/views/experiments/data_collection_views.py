...
import math
from math import pi
from dashboard.models import (Conversation, UserAction, Message, User, GroupMember, Group, Treatment, RFID, Task, Experiment, RFIDAssignment, WeightMeasurement, Collaborator, CalendarEvent, Comment, Friend, Cage, Animal, Sample, Dose, Observation, Comment, Strain, Organization)
...
from dashboard.forms import CustomUserCreationForm, UpdateProfileForm, ExperimentForm, DataInputMethodForm, TumorSizeEntryForm
import json
...
def data_collection(request, org_id, experiment_id):
    ...
    return render(request, 'data_collection/data-collection.html', context)
...
def data_collection_view(request, experiment_id):
    ...
    return render(request, 'data_collection/data-collection.html', {'form': form, 'experiment': experiment})
@require_POST
@login_required
...
def studies_view(request, org_id):
    ...
    return render(request, 'marketing/Studies.html', context)
@login_required
@csrf_exempt
...
from dashboard.models import WeightMeasurement, RFIDAssignment, Experiment, Organization
