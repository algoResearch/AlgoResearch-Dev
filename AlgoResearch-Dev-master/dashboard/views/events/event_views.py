...
from dashboard.models import (Conversation, EventCompletion, Message, User, Organization, GroupMember, Experiment, RFIDAssignment, WeightMeasurement, Collaborator, CalendarEvent, Comment, Friend, Cage, Animal, Sample, Dose, Observation, Comment)
...
from dashboard.forms import CustomUserCreationForm, UpdateProfileForm, ExperimentForm
import json
...
import csv
from dashboard.models import Invitation, UserAction, User
...
def calendar_view(request, org_id):
    ...
    base_template = 'admin/base_admin_dashboard.html' if '/admin/' in request.path else 'base/base_dashboard.html'
...
def agenda_view(request, org_id):
    ...
    return render(request, 'calendar/agenda.html', {'upcoming_events': upcoming_events})
@login_required
