...
urlpatterns = [
    ...
    path('ficcs/', home_views.ficcs_view, name='ficcs'),
    ...
    path('merit-based/', home_views.merit_based, name='merit_based'),
    path('faculty-screen/', home_views.faculty_screen, name='faculty_screen'),
    path('admission-track/', home_views.admission_track, name='admission_track'),
    path('civil-rights-monitor/', home_views.civil_rights_monitor, name='civil_rights_monitor'),
    path('syllabus-speaker/', home_views.syllabus_speaker, name='syllabus_speaker'),
    path('litmus-test/', home_views.litmus_test, name='litmus_test'),
    path('viewpoint-climate/', home_views.viewpoint_climate, name='viewpoint_climate'),
    path('ideological-tracker/', home_views.ideological_tracker, name='ideological_tracker'),
    path('anti-audit/', home_views.anti_audit, name='anti_audit'),
    path('report-escalation/', home_views.report_escalation, name='report_escalation'),
    path('internal-compliance/', home_views.internal_compliance, name='internal_compliance'),
    path('student-council/', home_views.student_council, name='student_council'),
    path('dei-asset/', home_views.dei_asset, name='dei_asset'),
    path('policy-redaction/', home_views.policy_redaction, name='policy_redaction'),
    path('personnel-compliance/', home_views.personnel_compliance, name='personnel_compliance'),

    path('sevis-visa/', home_views.sevis_visa, name='sevis_visa'),
    path('admission-transparency/', home_views.admission_transparency, name='admission_transparency'),
    path('dhs-escalate/', home_views.dhs_escalate, name='dhs_escalate'),
    path('foreign-fund/', home_views.foreign_fund, name='foreign_fund'),
    path('internation-applicant/', home_views.internation_applicant, name='internation_applicant'),
    path('ongoing-compliance/', home_views.ongoing_compliance, name='ongoing_compliance'),
