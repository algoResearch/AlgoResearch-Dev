...
from dashboard.models import (Conversation, Message, User, GroupMember, Experiment, RFIDAssignment, WeightMeasurement, Collaborator, CalendarEvent, Comment, Friend, Cage, Animal, Sample, Dose, Observation, Comment)
...
def map_rfid(request, experiment_id):
    ...
    return render(request, 'experiments/mapRFID.html', {'rfids': rfids, 'experiment': experiment})
