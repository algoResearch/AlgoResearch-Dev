...
class AuthFlowTests(TestCase):
    ...
    # -----------------------------
    # Commented out: attempts_left is 4 instead of None on first load
    ...
    # Commented out: locked_for is 0 instead of > 0 after threshold
    ...
    # -----------------------------
    # Commented out: No INFO logs triggered on dashboard.views.users.views_auth
...
class RememberMeTests(TestCase):
    ...
    # Commented out: Redirects to /dashboard/ instead of /account/two_factor/select/
